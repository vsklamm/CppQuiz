...
public enum Theme {
    A11Y_DARK("a11y-dark", true, false),
    A11Y_LIGHT("a11y-light", false, false),
    AGATE("agate", true, false),
    AN_OLD_HOPE("an-old-hope", true, false),
    ...
    ATOM_ONE_DARK_REASONABLE("atom-one-dark-reasonable", true, false),
    ...
    ISBL_EDITOR_DARK("isbl-editor-dark", true, false),
    ISBL_EDITOR_LIGHT("isbl-editor-light", false, false),
    KIMBIE_DARK("kimbie.dark", true, false),
    KIMBIE_LIGHT("kimbie.light", false, false),
    LIGHTFAIR("lightfair", false, false),
    ...
    SHADES_OF_PURPLE("shades-of-purple", true, false),
